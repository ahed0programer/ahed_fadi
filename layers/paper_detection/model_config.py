...
datasets = pd.read_csv('layers/paper_detection/Data Set/csv data/train.csv')
...
def load_and_preprocess_images(image_names, target_size=(img_rows, img_cols)):
    ...
    for img_name in image_names:
        img_path = 'layers/paper_detection/Data Set/train data/' + str(img_name)  
...
Y_train = to_categorical(train_data['class_name'], num_classes=2)
Y_test = to_categorical(test_data['class_name'], num_classes=2)
...
model.fit(X_train[0:1000], Y_train[0:1000], epochs = 50, batch_size = 22)
