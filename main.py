...
image = cv2.imread('Data/paper1.jpg')
...
model_path = 'layers/paper_detection/check_paper.h5'
...
answerExtractor = answer_extractor.Answer_Extractor('layers/Answer_predictor/check_answer_perdictor.h5')
