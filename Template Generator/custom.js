...
function createQuestions(num_of_elements) {
	...
	if (!isNaN(num_of_elements) && num_of_elements > 0) {
		...
		if (num_of_elements < 26) {
			...
			var num_of_quastion = createNumOfQuastion("" , "");
			circleContainer.appendChild(num_of_quastion);
			left_ul.appendChild(circleContainer);
			...
			var num_of_quastion = createNumOfQuastion("" , "");
			circleContainer.appendChild(num_of_quastion);
			center_ul.appendChild(circleContainer);
			...
			var num_of_quastion = createNumOfQuastion("" , "");
			circleContainer.appendChild(num_of_quastion);
			center2_ul.appendChild(circleContainer);
			...
			var num_of_quastion = createNumOfQuastion("" , "");
			circleContainer.appendChild(num_of_quastion);
			right_ul.appendChild(circleContainer);
		...
		for (var i = 1; i <= num_of_elements; i++) {
			...
			var circleContainer = createCircleContainer("circle-container");
			var num_of_quastion = createNumOfQuastion(i , "_");
			circleContainer.appendChild(num_of_quastion);
...
function createIdNum() {
	...
	function createCircle(num) {
		var circle = document.createElement("div");
		circle.className = "circle_num_id_child";
		var letter = document.createElement("span");
		letter.className = "letter";
	...
	for (let i = 1; i <= rowNum; i++) {
		var num_id_child = createCircleContainer("num_id_child line_bottom_for_num_id_child");
